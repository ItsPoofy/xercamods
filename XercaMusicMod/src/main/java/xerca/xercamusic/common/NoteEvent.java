...
public class NoteEvent implements Serializable {
    ...
    public void deserializeNBT(CompoundTag tag) {
        ...
        resetVibratoSettings();
        if (hasVibrato()) {
            this.vibratoDepthCents = tag.getByteOr("vd", DEFAULT_VIBRATO_DEPTH_CENTS);
            this.vibratoRateTenthsHz = tag.getByteOr("vr", DEFAULT_VIBRATO_RATE_TENTHS_HZ);
            this.vibratoDelayTicks = tag.getByteOr("vy", DEFAULT_VIBRATO_DELAY_TICKS);
            this.vibratoFadeTicks = tag.getByteOr("vf", DEFAULT_VIBRATO_FADE_TICKS);
            sanitizeVibratoSettings();
        }
    }
